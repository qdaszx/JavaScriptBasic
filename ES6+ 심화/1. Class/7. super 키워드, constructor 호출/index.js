...
슈퍼 클래스와 서브 클래스에
  - 같은 이름의 메소드가 있으면 서브 클래스의 메소드가 호출됩니다.

super 키워드를 사용하여
  - 슈퍼 클래스의 메소드를 호출할 수 있습니다.
  - super.getTitle() 형태 [코드1]
*/
...
서브와 슈퍼에 constructor를 모두 작성하지 않으면
  - 디폴트 constructor가 호출됩니다. [코드2]

서브에 작성하지 않고 슈퍼에만 작성하면 파라미터 값을 슈퍼로 넘겨줍니다. [코드3]

서브에는 작성하고 슈퍼에 작성하지 않으면 에러가 발생합니다. [코드4]

서브와 슈퍼에 constructor를 모두 작성하면 서브에서 super()로 호출해야 합니다. [코드5]
*/
