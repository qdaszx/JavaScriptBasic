...
클래스에 메소드 작성 방법 [코드1]
  - function 키워드를 작성하지 않습니다.
  - 메소드와 메소드 사이에 콤마(,)를 작성하지 않습니다.
  - 세미콜론(;) 작성은 선택입니다.

클래스의 typeof는 function 입니다.
...
메소드를 prototype에 연결하여 작성하지 않습니다. [코드3]

클래스 밖에서 메소드를 prototype에 연결할 수 있습니다. [코드4]
