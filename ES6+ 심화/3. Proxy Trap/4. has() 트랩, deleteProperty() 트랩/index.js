...
in 연산자의 트랩입니다.
  ...
  - 프로퍼티 값을 true/false로 변환하여 반환합니다. [코드1]
...
has() 트랩이 호출되는 형태
  - key in proxy
  - key in Object.create(proxy, {프로퍼티}) [코드2]
  - Reflect.has()
*/
...
오브젝트에 프로퍼티가 있으면서
  ...
  - false를 지정하여 반환할 수 없지만 true는 지정하여 반환할 수 있습니다.

강제로 true/false를 반환하지 않고
  - has() 트랩에서 구한 값을 true/false로 변환하여 반환합니다. [코드3]
*/
...
delete 연산자의 트랩입니다.
  - 오브젝트의 프로퍼티를 삭제합니다. [코드4]

delete 연산자는
  - 프로퍼티가 없어도 true를 반환하므로
  - 코드처럼 조건을 체크하여 true/false 반환하면 완전하게 처리할 수 있습니다.
*/
...
/*
deleteProperty() 트랩 준주사항

target 오브젝트의 프로퍼티가
  - [[Configurable]]: false이면
  - 프로퍼티를 삭제할 수 없으며 에러가 발생합니다. [코드5]
*/
