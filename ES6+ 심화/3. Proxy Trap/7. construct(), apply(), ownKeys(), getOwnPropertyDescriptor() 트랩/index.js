...
함수 호출 트랩입니다.
  - Proxy 인스턴스 호출로 트랩이 실행된 형태입니다. [코드2]
  - call(), apply() 호출로 트랩이 실행된 형태로 다음 페이지에 다룹니다.
*/
...
apply() 트랩이 호출되는 형태
  - Function.prototype.apply() [코드3]
  - Function.prototype.call() [코드4]
