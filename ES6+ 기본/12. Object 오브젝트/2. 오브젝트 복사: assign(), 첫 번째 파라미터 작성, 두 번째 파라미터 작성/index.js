...
구분 ::: 데이터(값)
형태 ::: Objcet.assign()
파라미터 ::: 1. 열거 가능 오브젝트 2. 열거 가능 오브젝트opt 다수 작성 가능
반환 ::: 첫 번째 파라미터 오브젝트

- 두 번째 파라미터의 오브젝트 프로퍼티를 첫 번째 파라미터의 오브젝트에 복사하고 첫 번째를 반환 [코드1]
  - own property만 복사
*/
...
- 첫 번째 파라미터는 반드시 작성 [코드2]

- Number, String, Symbol, Boolean 값 [코드3]
*/
