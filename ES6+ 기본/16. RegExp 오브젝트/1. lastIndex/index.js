...
- g 플래그를 사용하면
  - lastIndex 프로퍼티 위치부터 매치 [코드2]
  - const value = "ABABA", obj = /B/g

- g 플래그를 사용하지 않으면
  - lastIndex 프로퍼티 값이 바뀌지 않음 [코드3]
  - lastIndex 값을 지정해도 적용되지 않고 0번 인덱스부터 매치 [코드4]
*/
