...
파라미터 ::: 1. 비교 문자열 2. 비교 시작 인덱스 opt 디폴트: 0
반환 ::: 시작하면 true, 아니면 false

- 대상 문자열이
    - 첫 번째 파라미터의 문자열로 시작하면 true, 아니면 false 반환 [코드1]
    - 정규 표현식 사용 불가

- 두 번째 파라미터
    - 선택이며, 비교 시작 인덱스 작성 [코드2]
*/
...
구분 ::: 데이터(값)
파라미터 ::: 1. 비교 문자열 2. 사용 문자열 길이opt 디폴트: 문자열 전체
반환 ::: 끝나면 true, 아니면 false

- 대상 문자열이
    - 첫 번째 파라미터의 문자열로 끝나면 true, 아니면 false 반환 [코드3]

- 두 번째 파라미터
    - 선택이며, 사용할 문자열 길이 지정 [코드4]
*/
...
- 대상 문자열을 파라미터에 작성한 수 만큼 복제, 연결하여 반환 [코드1]
*/
...
파라미터 ::: 1. 존재 여부 비교 문자열 2. 비교 시작 인덱스opt 디폴트: 0
반환 ::: 존재하면 true, 아니면 false

- 대상 문자열에 첫 번째 파라미터의 문자열이 있으면 true 없으면 false 반환 [코드6]
