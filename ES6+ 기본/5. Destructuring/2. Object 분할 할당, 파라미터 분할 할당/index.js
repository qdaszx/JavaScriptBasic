...
- 프로퍼티 이름이 같은 프로퍼티에 값을 할당 [코드1]
- 프로퍼티 이름을 별도로 작성 [코드2]
- 프로퍼티 값 위치에 변수 이름 작성 [코드3]
- Object 구조에 맞추어 값 할당 [코드4]
- 나머지를 Object로 할당 [코드5]
*/
 ...
 * 2. 오른쪽 two 프로퍼티 값 6을 six에 할당합니다.
...
const { one4, plus4: { two4, three4 } } = { one4: 10, plus4: { two4: 20, three4: 30 } };
...
- 호출하는 함수에서 Object 형태로 넘겨준 파라미터 값을 호출받는 함수의 파라미터에 맞추어 할당 [코드6]

- Object 구조에 맞추어 값 할당 [코드7]
*/
